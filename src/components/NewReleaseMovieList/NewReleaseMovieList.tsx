...
const NewReleaseMovieList = () => {
    ...
    const getNewReleases = () => {
        GlobalAPI.getNewReleaseMovies().then((resp) => {
        ...
        <div className="new-release-section position-relative my-4">
            ...
            <div className="newRealeaseMovieList d-flex gap-4 overflow-auto" ref={scrollRef}>
                {newReleases.map((movie) => (
                    <div key={movie.id}  onClick={() => navigate(`/detail/${movie.id}`)} className="newRealeaseMovieCard position-relative flex-shrink-0">
